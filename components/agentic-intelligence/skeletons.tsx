...
import { LogoSVG, TandemIcon } from "../logo";
  ...
  const models = [
    {
      ...
      logo: () => <TandemIcon className="h-4 w-4" />,
      status: "Active",
      variant: "success",
    },
    {
  ...
  return (
    <motion.div className="relative mx-auto mt-20 h-full max-h-70 min-h-40 w-[85%] rounded-2xl border-t border-gray-300 bg-white p-4 shadow-2xl dark:border-neutral-700 dark:bg-neutral-800">
      ...
      >
        <div className="flex w-full items-center justify-between p-2">
          <div className="flex items-center gap-2 font-medium">
            <TandemIcon className="h-4 w-4" />
            Tandem
          </div>
          <p className="font-mono text-green-600">Live</p>
        </div>
        <DivideX />
        <div className="m-2 rounded-sm border border-green-500 bg-green-50 px-2 py-0.5 text-green-600 dark:bg-green-50/10">
          Copilot Active
        </div>
      </motion.div>
      ...
      <div className="mt-12 flex items-center gap-2">
        <TandemIcon className="h-5 w-5" />
        <span className="text-charcoal-700 text-sm font-medium dark:text-neutral-200">
          Active Guides
        </span>
        <span className="text-charcoal-700 rounded-lg border border-green-200 bg-green-50 px-2 py-0.5 text-xs dark:border-green-600 dark:bg-green-900/20 dark:text-neutral-200">
          24/7
        </span>
      </div>
...
export const TextToWorkflowBuilderSkeleton = () => {
  const initialChat = [
    ...
    {
      role: "assistant",
      content: "I'll help you export your data. Go to Settings > Data > Export, then select your preferred format.",
    },
    {
      role: "user",
      content:
    ...
    {
      role: "assistant",
      content: "Click on your profile → Developer Settings → API Keys. You can create new keys there.",
    },
  ];
  ...
  const RANDOM_MESSAGES = [
    "I'll guide you through that. Navigate to your dashboard and click on the setup wizard.",
    "You can find that in Settings > Integrations. Would you like me to take you there?",
    "I can help you set that up. First, complete your profile, then you'll have access to this feature.",
    "That's a premium feature. Would you like to upgrade your plan to access it?",
    "Let me walk you through it step by step. Click on the menu icon in the top-right corner...",
  ];
...
export const NativeToolsIntegrationSkeleton = () => {
  return (
    <>
      <motion.div className="relative mx-auto my-12 h-full max-h-70 min-h-80 max-w-[67rem] grid-cols-1 p-4 sm:grid-cols-2 grid">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-10">
            <TextIconBlock icon={<WindowIcon />} text="User Onboarding">
              <TopSVG className="absolute top-2 -right-84" />
            </TextIconBlock>
            <TextIconBlock icon={<CodeIcon />} text="Feature Discovery">
              <MiddleSVG className="absolute top-2 -right-84" />
            </TextIconBlock>
            <TextIconBlock icon={<PhoneIcon />} text="Setup Assistance">
          ...
          <div className="relative h-16 w-16 overflow-hidden rounded-md bg-gray-200 p-px shadow-xl dark:bg-neutral-700">
            ...
            <div className="relative z-20 flex h-full w-full items-center justify-center rounded-[5px] bg-white dark:bg-neutral-900">
              <TandemIcon className="h-8 w-8" />
            </div>
          </div>
        </div>
        <div className="relative flex h-full w-full items-center justify-start gap-4">
          <RightSideSVG />
          <span className="relative z-20 rounded-sm border border-brand bg-brand/10 px-2 py-0.5 text-xs text-brand dark:bg-brand/20 dark:text-brand">
            Frontend
          </span>
          <RightSideSVG />
          <div className="rounded-md border border-gray-200 bg-white px-4 py-2 dark:border-neutral-700 dark:bg-neutral-900">
            <p className="whitespace-nowrap text-sm font-medium text-gray-600 dark:text-neutral-400">
              Your tool
            </p>
          </div>
        </div>
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.5" stopColor="#30f191" />
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="var(--color-line)" />
          <stop offset="0.33" stopColor="#30f191" />
          <stop offset="0.66" stopColor="#30f191" />
          <stop offset="1" stopColor="var(--color-line)" />
        </motion.linearGradient>
      </defs>
    </svg>
