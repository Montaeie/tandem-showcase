  ...
  return (
    <div className="mt-12 flex flex-col items-center">
      <div className="relative">
        <Card
          title="Your Product"
          subtitle="Tandem Copilot"
          logo={<TandemIcon className="h-8 w-8" />}
          cta="Installed"
          tone="default"
        />
...
export const ConnectYourTooklsSkeleton = () => {
  const text = `How do I configure my payment settings?`;
    ...
    <div className="relative flex h-full w-full items-center justify-between">
      ...
      >
        <div className="absolute -top-4 -right-4 flex h-14 w-14 items-center justify-center rounded-lg bg-white shadow-xl dark:bg-neutral-800">
          <Scale />
          <TandemIcon className="relative z-20 h-8 w-8" />
        </div>
      ...
      >
        ...
        <div className="mt-4 flex items-center justify-between gap-2">
          ...
          <div className="rounded-sm border border-green-500 bg-green-50 px-2 py-0.5 text-xs text-green-600">
            Step 1
          </div>
        </div>
        <div className="mt-4 flex items-center justify-between gap-2">
...
export const DeployAndScaleSkeleton = () => {
  ...
  // Define user actions guided by Tandem
  const deployCards = [
    { title: "Profile completed", subtitle: "2m ago", branch: "Sarah M.", variant: "success" as const },
    {
    ...
    { title: "Feature discovered", subtitle: "8m ago", branch: "Emma D." },
    {
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#30f191" stopOpacity="1" offset="0.5" />
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop stopColor="#30f191" stopOpacity="0.5" offset="0.5" />
          <stop stopColor="#30f191" stopOpacity="0" offset="1" />
        </motion.linearGradient>
      </defs>
    </motion.svg>
  );
