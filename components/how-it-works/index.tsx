...
export const HowItWorks = () => {
  const tabs = [
    {
      title: "Install Tandem",
      description:
        "Embed Tandem directly into your product with a few lines of code. Native integration that feels like part of your UI.",
      icon: FirstIcon,
      id: "workflow",
      skeleton: <DesignYourWorkflowSkeleton />,
    },
    {
      title: "Customize Guidance",
      description:
        "Tailor the copilot experience to your product's unique workflows and user needs with intelligent context awareness.",
      icon: SecondIcon,
      id: "tools",
    ...
    },
    {
      ...
      description:
        "Help users discover features, complete tasks, and achieve their goals with proactive AI assistance.",
      icon: ThirdIcon,
      id: "deploy",
  ...
  return (
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SectionHeading className="mt-4">Simple Integration</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Get started in minutes with Tandem's native copilot. Install, customize, and start guiding your users to success.
        </SubHeading>
        {/* Desktop Tabs */}
