    ...
    <Container>
      <div className="grid grid-cols-1 px-4 py-20 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8">
        <div className="mb-6 sm:col-span-2 md:col-span-4 lg:col-span-3">
          ...
          <SubHeading as="p" className="mt-4 max-w-lg text-left text-sm">
            Your product's AI copilot. Lives natively in your app to guide, explain, and complete tasks for users.
          </SubHeading>
          <Button className="mt-4 mb-8 inline-block w-fit lg:mb-0" as={Link} href="/contact">Book a demo</Button>
        </div>
        ...
        <div className="col-span-1 mb-4 flex flex-col items-start md:col-span-1 md:mb-0 lg:col-span-2">
          <p className="text-footer-link text-sm font-medium">Resources</p>
          <Link href="/blog" className="text-footer-link my-2 text-sm font-medium">
            Blog
          </Link>
          <Link href="/contact" className="text-footer-link my-2 text-sm font-medium">
            Help Center
          </Link>
          <Link href="/customers" className="text-footer-link my-2 text-sm font-medium">
            Customer Stories
          </Link>
          <SubHeading
            as="p"
