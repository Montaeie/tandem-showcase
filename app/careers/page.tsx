...
export const metadata = getSEOTags({
  title: "Careers | Tandem AI",
  description:
    "Join us in building the future of user guidance. We're creating native AI copilot experiences that help users succeed in complex products by guiding, explaining, and completing tasks.",
    ...
    <main>
        ...
        <div className="divide-divide border-divide grid grid-cols-1 border-b lg:grid-cols-2 lg:divide-x">
          <div className="flex flex-col items-start justify-start px-4 py-10 md:px-8 md:py-32">
            ...
            <SubHeading className="mt-6 mr-auto max-w-md text-left">
              Join a team of exceptional builders creating native AI copilot experiences that transform how millions of users interact with complex products.
            </SubHeading>
            <Button className="mt-4" as={Link} href="#open-roles">View Roles</Button>

            <div className="mt-8 flex items-center gap-4">
              <h2 className="font-mono text-sm tracking-tight text-neutral-500 uppercase">
                Backed by
              </h2>
              <Image
      ...
      <Container className="border-divide border-x border-b px-4 pb-20 md:px-8">
        <div className="py-10 md:py-20">
          <h2 className="mb-8 text-center font-mono text-sm tracking-tight text-neutral-500 uppercase dark:text-neutral-400">
            Life at Tandem
          </h2>
