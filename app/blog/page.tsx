...
export const metadata = getSEOTags({
  title: "Blog | Tandem AI",
  description:
    "Insights, updates, and best practices for transforming user experiences with native AI guidance. Learn how companies are scaling user success with Tandem.",
  ...
  return (
    <div>
      ...
      <Container className="border-divide flex flex-col items-center border-x pt-10 md:pt-20 md:pb-10">
        <Badge text="Insights" />
        <Heading>Latest from Tandem</Heading>
        <SubHeading className="mx-auto mt-2 max-w-sm px-4">
          Discover how companies are transforming user experiences with native AI guidance. Best practices, product updates, and customer success stories.
        </SubHeading>
